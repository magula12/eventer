      ...
      class Plan
        ...
        def initialize(date, is_workday, resource_bookings, time_entries, workday_length)
          ...
          if @is_workday == 'dayoff'
            ...
            @workload_card = Components::WorkloadCard.new(@is_workday, @resource_bookings, @time_entries, @workday_length)
          end
        ...
        def build_project_plan_card
          Components::ProjectPlanCard.new(@is_workday, @allocated_hours, @workday_length)
        end
